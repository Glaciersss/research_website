...
function TeamManagement() {
  ...
  return (
    <div>
      ...
      <p style={{ fontSize: '15px', color: '#999', marginBottom: '10px' }}>
        ...
        <table className="table">
          ...
          <tbody>
            {members.map(member => (
              ...
              >
                <td style={{ textAlign: 'center', color: '#ccc', fontSize: '19px', cursor: 'grab' }}>⋮⋮</td>
                <td>
      ...
      {showModal && (
        ...
        >
          <div className="card" style={{ width: '600px', maxHeight: '80vh', overflow: 'auto' }}>
            <h3 style={{ marginBottom: '20px' }}>{editingItem ? '编辑成员' : '添加成员'}</h3>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div style={{ marginBottom: '15px' }}>
                ...
                <textarea
                  ...
                  placeholder="填写成员的研究兴趣、教育背景或个人简介"
                />
              </div>
              ...
              <div style={{ marginBottom: '15px' }}>
                ...
                >
                  {projects.length === 0 && <span style={{ color: '#999', fontSize: '15px' }}>暂无可选学术成果</span>}

            ...
            <form onSubmit={handleSubmit}>
              ...
              <div style={{ marginBottom: '15px' }}>
                ...
                <select className="input" value={formData.type} onChange={e => setFormData({ ...formData, type: e.target.value })}>
                  ...
                  <option value="teaching">教学活动</option>
                </select>
              </div>
              <div style={{ marginBottom: '15px' }}>
                <label style={{ display: 'block', marginBottom: '5px', fontSize: '15px' }}>作者/负责人</label>
                <input
                  type="text"
                  className="input"
              ...
              <div style={{ display: 'flex', gap: '10px', marginBottom: '15px' }}>
                <div style={{ flex: 1 }}>
                  <label style={{ display: 'block', marginBottom: '5px', fontSize: '15px' }}>年份</label>
                ...
                <div style={{ flex: 1 }}>
                  <label style={{ display: 'block', marginBottom: '5px', fontSize: '15px' }}>链接 (DOI等)</label>
                  <input type="url" className="input" value={formData.link} onChange={e => setFormData({ ...formData, link: e.target.value })} placeholder="https://..." />
                </div>
              </div>
              <div style={{ marginBottom: '15px' }}>
                <label style={{ display: 'block', marginBottom: '5px', fontSize: '15px' }}>出版信息</label>
                <input
                  type="text"
                  className="input"
                  value={formData.publication_info}
                  onChange={e => setFormData({ ...formData, publication_info: e.target.value })}
                  placeholder="期刊/会议名称等"
                />
              </div>
              <div style={{ marginBottom: '15px' }}>
                <label style={{ display: 'block', marginBottom: '5px', fontSize: '15px' }}>摘要</label>
                <textarea className="input" rows="6" value={formData.abstract} onChange={e => setFormData({ ...formData, abstract: e.target.value })} />
              </div>
              <div style={{ marginBottom: '15px' }}>
                <label style={{ display: 'block', marginBottom: '5px', fontSize: '15px' }}>关键词</label>
                <input
                  type="text"
                  className="input"
              ...
              <div style={{ marginBottom: '15px' }}>
                <label style={{ display: 'block', marginBottom: '5px', fontSize: '15px' }}>论文配图（可上传多张）</label>
                ...
                <div style={{ display: 'flex', gap: '8px', marginTop: '8px' }}>
                  ...
                  <button type="button" className="btn btn-secondary" onClick={addFigureUrl}>
                    添加
                  </button>
                </div>
              </div>
              <div style={{ marginBottom: '15px' }}>
                <label style={{ display: 'block', marginBottom: '5px', fontSize: '15px' }}>配图说明</label>
              ...
              <div style={{ marginBottom: '15px' }}>
                <label style={{ display: 'block', marginBottom: '5px', fontSize: '15px' }}>PDF 文件</label>
                {formData.pdf_url && (
                  <div style={{ marginBottom: '8px' }}>
                    ...
                    <button
                      ...
                      style={{ marginLeft: '8px', background: '#c1272d', color: '#fff', border: 'none', borderRadius: '50%', width: '18px', height: '18px', fontSize: '15px', cursor: 'pointer' }}
                    >
                      ×
                    </button>
                  </div>
              ...
              <div style={{ display: 'flex', gap: '10px', marginBottom: '15px' }}>
                <div style={{ flex: 1 }}>
                  <label style={{ display: 'block', marginBottom: '5px', fontSize: '15px' }}>Code 网址</label>
                ...
                <div style={{ flex: 1 }}>
                  <label style={{ display: 'block', marginBottom: '5px', fontSize: '15px' }}>DOI 网址</label>

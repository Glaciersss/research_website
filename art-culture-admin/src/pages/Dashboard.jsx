...
function Dashboard() {
  ...
  const menuItems = [
    ...
    { path: '/projects', label: '学术成果管理' },
    { path: '/team', label: '团队成员管理' },
    { path: '/notices', label: '通知公告管理' },
    { path: '/events', label: '投稿日历管理' },
    ...
    <div style={{ display: 'flex', minHeight: '100vh' }}>
      ...
      <aside style={{
        ...
        <div style={{ padding: '0 20px', marginBottom: '30px' }}>
          <h3 style={{ fontSize: '16px', marginBottom: '5px' }}>管理后台</h3>

  ...
  return (
    <div style={style.page}>
      ...
      <div style={style.section}>
          ...
          <div style={style.previewGrid}>
            {images.map((url, index) => (
              <div key={index} style={style.previewItem}>
                ...
                <button style={style.removeBtn} onClick={() => handleRemove(index)}>×</button>
              </div>
            ))}
          </div>
        ) : (
        ...
        <div style={style.tip}>轮播顺序即图片展示顺序，先上传的先播放。点击右上角 × 可移除单张图片。</div>
      </div>
      ...
      <div style={style.section}>
        ...
        >
          ...
          <div style={{ fontSize: '13px', color: '#999' }}>
            支持 PNG、JPG 格式，建议尺寸 1920×1080，最大 40MB
          </div>
          <input
            ref={fileInputRef}
            type="file"
